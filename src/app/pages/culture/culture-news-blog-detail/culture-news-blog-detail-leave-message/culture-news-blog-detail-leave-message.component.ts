...
@Component({
  selector: 'app-culture-news-blog-detail-leave-message',
  templateUrl: './culture-news-blog-detail-leave-message.component.html',
  styleUrls: ['./culture-news-blog-detail-leave-message.component.scss']
})
export class CultureNewsBlogDetailLeaveMessageComponent implements OnInit {
