...
@Component({
  selector: 'app-culture-news-blog-detail-comments',
  templateUrl: './culture-news-blog-detail-comments.component.html',
  styleUrls: ['./culture-news-blog-detail-comments.component.scss']
})
export class CultureNewsBlogDetailCommentsComponent implements OnInit {
